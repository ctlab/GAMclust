...
work.dir <- "~/Documents/4projects/nets/GAM-clustering/runs/tms_delCor2_10-5_0.5-0.05"
...
```{r centers, eval=FALSE, echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("inst/vignette-data/centers.png")
```

```{r graphANDheatmap, eval=FALSE, echo=FALSE, fig.cap="", out.width = '100%'}
...
```{r comparison, eval=FALSE, echo=FALSE, fig.cap="", out.width = '100%'}
