...
For single cell data, take 6,000-12,000 genes for GAM-clustering analysis. 
...
<img src="/nfs/home/againullina/GAMclust/results/m.3.svg" type="image/svg+xml" />
...
```{r}
head(read.tsv(paste0(work.dir, "/m.3.genes.tsv")))
```
...
```{r}
head(read.tsv(paste0(work.dir, "/m.3.pathways.tsv")))
```
