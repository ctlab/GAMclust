...
Let's load the data. (If you analyse multi-sample data, after per-sample `SCTransform()` application do not forget to set `nfeatures=10000` in `SelectIntegrationFeatures()`).

```{r}
seurat_object <- readRDS("data.rds")

seurat_object1 <- Seurat::SCTransform(seurat_object, 
                                      new.assay.name = "SCT", 
